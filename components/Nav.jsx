...
export default function Nav({show, toggleNav}) {
  ...
  const activeNav = "top-0 text-gray-500 p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"
  const inactiveNav = activeNav + " -left-full"
  ...
  return (
    <aside className={show?activeNav:inactiveNav} >
